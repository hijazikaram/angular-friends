...
app.controller("FriendController", function($scope){
	$scope.foo = "sup, broseph!!";

	$scope.searchOpts = [
		{display:'Name', json:'name'},
		{display:'Location', json:'current_location.$'},
		{display:'#Friends', json:'friend_count'}
	];

	$scope.sortAttribute = '$$hashKey';
	$scope.sortAscending = '';
	$scope.sort = $scope.sortAscending + $scope.sortAttribute;
